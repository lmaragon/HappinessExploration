...
# Group Regions
#levels(happy.data$Region)[levels(happy.data$Region)=="Western Europe"] <- "Europe"
#levels(happy.data$Region)[levels(happy.data$Region)=="North America"] <- "America"

#library(data.table)
#happydt = data.table(happy.data)

#one_hot(happydt, cols = "Region", sparsifyNAs = FALSE, naCols = FALSE, dropCols = TRUE, dropUnusedLevels = FALSE)
```
